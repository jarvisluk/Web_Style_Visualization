...
const translations = {
  en: {
    ...
    "ai.error.quotaExceeded": "API quota exceeded or insufficient balance. Please check your account billing and usage limits.",
    ...
    "ai.model": "Model",
    "ai.modelLoading": "Loading models...",
    "ai.modelFetchFail": "Could not fetch models, enter manually",
    "ai.modelCustom": "Custom model...",
    "ai.stop": "Stop",
    "ai.retry": "Retry",
  ...
  zh: {
    ...
    "ai.error.quotaExceeded": "API 配额已用尽或余额不足，请检查你的账户计费和使用限额。",
    ...
    "ai.model": "模型",
    "ai.modelLoading": "加载模型列表中...",
    "ai.modelFetchFail": "无法获取模型列表，请手动输入",
